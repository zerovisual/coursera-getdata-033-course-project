...
## Data Set Information ( Directly from http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones)
...
## The data (Directly from the Readme file)
